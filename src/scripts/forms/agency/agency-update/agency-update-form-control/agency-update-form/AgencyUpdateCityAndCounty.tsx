...
import { AgencyUpdateFormValues } from '../AgencyUpdateForm';
import {
    AgencyUpdateFormContext,
    AgencyUpdateFormContextProps
} from '../AgencyUpdateFormContext';

export interface AgencyUpdateCityAndCountyProps {
    readonly setFieldValue?: FormikActions<AgencyUpdateFormValues>['setFieldValue'];
    readonly city?: City;
...
export class AgencyUpdateCityAndCounty extends React.PureComponent<
    ...
    static readonly contextType = AgencyUpdateFormContext;
    readonly context!: AgencyUpdateFormContextProps;

    constructor(props: AgencyUpdateCityAndCountyProps, context: AgencyUpdateFormContextProps) {
        super(props);
    ...
    public render() {
        ...
        return (
            <Row gutter={15}>
                <Col span={12}>
                    <FormSelect
                        name={nameof.full<AgencyUpdateFormValues>(o => o.city!.id)}
                        value={city && city.id}
                ...
                <Col span={12}>
                    <FormSelect
                        name={nameof.full<AgencyUpdateFormValues>(o => o.county!.id)}
