...
interface OrderDetailsPhotosState {
    readonly previewVisible: boolean;
    readonly previewImage: string;
    readonly fileList: UploadFile[];
}

export class OrderDetailsPhotos extends React.PureComponent<
    OrderDetailsPhotosProps,
    OrderDetailsPhotosState
    > {
    constructor(props: OrderDetailsPhotosProps) {
        super(props);
        const { order } = props;
        this.state = {
